...
<tbody>
    <tr v-for="staff in staffs">
        ...
        <td>
            ...
            <button type="button" @click="deleteClick(staff.id)"
            class="btn btn-light mr-1">
    ...
    <div class="d-flex flex-row bd-highlight mb-3">
        <div class="p-2 w-50 bd-highlight">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" v-model="staffId">
            </div>
        ...
        v-if="addingNewStaff" class="btn btn-primary">
        Create
        </button>
...
methods:{
    ...
    addClick(){
        ...
        this.addingNewStaff = true // Signal that we are adding a new staff -> Create Button.
    ...
    createClick(){
        axios.post(variables.API_URL+"staff",{
    ...
    updateClick(){
        axios.put(variables.API_URL+"staff",{
            id:         this.id,
            staffId:    this.staffId,
            firstname:  this.firstname,
            middlename: this.middlename,
    ...
    deleteClick(id){
        ...
        axios.delete(variables.API_URL+"staff/"+id)
        .then((response)=>{
            this.refreshData();
            alert(response.data);
        });
