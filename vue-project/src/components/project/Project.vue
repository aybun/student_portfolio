          ...
          <div class="modal-body">
            <div class="d-flex flex-row bd-highlight mb-3">
              <div class="p-1 w-50 bd-highlight">
                <FormulateForm
                  name="project-formulate-form-1"
                  ref="project-formulate-form-1"
                  #default="{ hasErrors }"
                >
                  <formulate-input
                    ref="project-formulate-input-title"
                    type="text"
                  ...
                  ></formulate-input>
                  <formulate-input
                    ref="project-formulate-input-start_date"
                    type="date"
                    v-model="project.start_date"
                    label="Start Date"
                    validation="required"
                    :readonly="modalReadonly || !formRender.edit.start_date"
                  ></formulate-input>
                  <formulate-input
                    ref="project-formulate-input-end_date"
                    type="date"
                    v-model="project.end_date"
                    label="End Date"
                    validation="required"
                    :readonly="modalReadonly || !formRender.edit.end_date"
                  ></formulate-input>
                  <formulate-input
                    ref="project-formulate-input-info"
                    label="Info"
                    :key="'project-formulate-input-info-' + formKey"
                    type="textarea"
                  ...
                  <div class="mb-3">
                    <FormulateInput
                      ref="project-formulate-input-approved"
                      v-model="checkboxes"
                    ...
                    ></FormulateInput>
                    <FormulateInput
                      ref="project-formulate-input-used_for_calculation"
                      v-model="checkboxes"
                  ...
                  <FormulateInput
                    ref="project-formulate-input-attachment_link"
                    type="url"
                    v-model="project.attachment_link"
                  ...
                  <FormulateInput
                    type="file"
                    :key="'project-formulate-input-attachment_file-' + formKey"
                    ref="project-formulate-input-attachment_file"
                    name="project-formulate-input-attachment_file"
  ...
  methods: {
    ...
    async createClick() {
      ...
      axios({
        ...
        let stringified = JSON.stringify(response.data.data)
